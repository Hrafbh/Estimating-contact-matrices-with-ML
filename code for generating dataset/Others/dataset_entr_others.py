...
df.to_excel('dataset_contact_others.xlsx', sheet_name='dataset',header=[f'feature_{i+1}' for i in range(512)]+[f'mat_{i},{j}'for i in range(1,17) for j in range(1,17)])#run this code to build the dataset