...
C=[]
for i in range(120):
    file_loc=r"E:\Hraf\S8\Projet à Enjeux\Projet Enjeux\matrix_contact_177country\data_contact_all.xls"
...
df.to_excel('dataset_contact_norm_all.xlsx', sheet_name='dataset',header=[f'feature_{i+1}' for i in range(64)]+['norme_mat'])#run this code to build the dataset
